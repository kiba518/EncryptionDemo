...
namespace EncryptionDemo
{
    class SM2Utils
    {
        public static void GenerateKeyPair()
        {
            ...
            System.Console.Out.WriteLine("GenerateKeyPair公钥: " + Encoding.Default.GetString(Hex.Encode(publicKey.GetEncoded())).ToUpper());
            System.Console.Out.WriteLine("GenerateKeyPair私钥: " + Encoding.Default.GetString(Hex.Encode(privateKey.ToByteArray())).ToUpper());
        }
